...
class JSONImplFactory implements ObjectFactory {
    ...
    @Override
    public ResponseList<DirectMessageEvent> createDirectMessageEventList(HttpResponse res) throws TwitterException {
        return DirectMessageEventJSONImpl.createDirectMessageEventList(res, conf);
    }
